...
Licensor:             Laurent Bindschaedler

Licensed Work:        codemux
...
(this “License”), the text of which follows. Other than the text in the
“Parameters” section above, all other text in this License is provided without
modification.
...
other recipients of the licensed work, that Licensor will:

1. Specify as the Change License the GPL Version 2.0 or later, or a license
   that is compatible with GPL Version 2.0 or later, where “compatible” means
   that software provided under the Change License can be included in a
   program with software provided under GPL Version 2.0 or later. Licensor may
   specify additional Change Licenses without limitation.

2. Either: (a) specify an additional grant of rights to use that does not
